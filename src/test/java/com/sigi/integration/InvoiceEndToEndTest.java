...
class InvoiceEndToEndTest {
    ...
    @Test
    void fullInvoiceFlow() throws Exception {
        // client
        ...
        // warehouse
        NewWarehouseDto newWarehouse = new NewWarehouseDto("Main Warehouse2", "Location A1", 100);
        ...
        // dispatcher
        NewDispatcherDto newDispatcherDto = new NewDispatcherDto("Dispatcher1","1111111","Colombia","212123122","dispatcher1@sigi.com","dispatcher");
        ...
        // invoice
        NewInvoiceDto newInvoice = NewInvoiceDto.builder()
                .orderId(UUID.fromString(orderId))
                .tax(BigDecimal.valueOf(570))
                .build();
        ...
        JsonNode invoiceNode = objectMapper.readTree(invoiceJson);
        String invoiceId = invoiceNode.get("data").get("id").asText();
